...
IBM z/OS   │  COBOL      │  JCL
DB2        │  CICS       │  REXX
TSO/ISPF   │  IBM zSeries
```

> Enterprise-grade. Battle-tested. Built for systems where downtime isn't an option.
...
- **[Kitsune Study](https://github.com/Elelias0/study_japanese)** — A Japanese JLPT prep app with AI-powered exercises, SRS, and gamification. Built with FastAPI + React + PostgreSQL.
- **[Katakana Game](https://github.com/Elelias0/katakana-game)** — A fast, lightweight browser game to drill katakana recognition.
